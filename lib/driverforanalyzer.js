...
DriverForAnalyzer.prototype.readingDataEntry = function (data) {
  ...
  var newStringReceived = this.cleanSpecialCharacters(data);
...
DriverForAnalyzer.prototype.readingAndResponseDataEntry = function (data) {
  ...
  if ( this.getProtocolASTM().isValidRecord(this.getStringReceived()) ) {
    // Leer los datos de entrada
    readStatus = this.readingDataEntry(this.getStringReceived());
  } else {
    // Cambiar la Data
    dataModified = this.toChangeData(this.getStringReceived());
